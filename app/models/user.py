...
class User(db.Model, UserMixin):
    ...
    def to_dict(self):
        return {
            ...
            'followers': [{'id':user.id, 'name':user.name, 'profile_img':user.profile_img} for user in self.followers],
            'following': [{'id':user.id, 'name':user.name, 'profile_img':user.profile_img} for user in self.following]
        }
